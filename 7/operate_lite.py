...
class OperateExecution():
    ...
    def run_posture(self, joint_goal):
        ...
        # クラスのメソッドをリストアップする例
        print(dir(self.hand_commander))

        # 例: コントローラーのパラメータを確認する
        controller_params = self.hand_commander.get_controller_params()
        rospy.loginfo(f"Controller Parameters: {controller_params}")
