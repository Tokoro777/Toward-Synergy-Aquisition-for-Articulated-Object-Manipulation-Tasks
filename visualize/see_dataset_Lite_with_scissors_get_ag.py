...
model = load_model_from_path("/home/tokoro/.mujoco/synergy/gym-grasp/gym_grasp/envs/assets/hand/grasp_object_Lite.xml")
sim = MjSim(model)

dataset_path = "/home/tokoro/policy_without_WRJ1J0THJ2_Lite/test/{}"
...
while pos_num < len(postures):
    ...
    if t > 500:
        ...
        postures[pos_num][-1] = ag_value  # posturesの最後の要素(zsliderの値)をagの値に更新
    ...
    if pos_num < len(postures):  # pos_numが範囲内か確認  # zslider以外のactuatorに制御入力を与える. zsliderはどうせ0.2になるので.
