...
base_dir = os.path.join(args.dir, "policy_2finger", "test")

# 各ファイルのパスと対応するdesired_agの値
files_with_ag = [
    (os.path.join(base_dir, "error_with_desired_ag=0.0_in_ramdom_hand_1degree_modify.txt"), 0.0), #error_with_desired_ag=0.0_in_ramdom_hand_2degree.txt
    (os.path.join(base_dir, "error_with_desired_ag=0.2_in_ramdom_hand_1degree_modify.txt"), 0.2),
    (os.path.join(base_dir, "error_with_desired_ag=0.4_in_ramdom_hand_1degree_modify.txt"), 0.4),
    (os.path.join(base_dir, "error_with_desired_ag=0.6_in_ramdom_hand_1degree_modify.txt"), 0.6),
    (os.path.join(base_dir, "error_with_desired_ag=0.7_in_ramdom_hand_1degree_modify.txt"), 0.7)
]
...
plt.savefig(os.path.join(base_dir, "boxplot_degrees_ramdom_hand_1degree_abs_0-12.png")) # boxplot_degrees_ramdom_hand_2degree ,boxplot_degrees_-30-10.png"
plt.show()